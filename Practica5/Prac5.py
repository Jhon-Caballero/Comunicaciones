...
class Prac5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prac5")
        ...
        # Blocks
        ##################################################
        self._kp_range = Range(0, 100, 0.1, 1, 200)
        ...
        self.connect((self.EnvolventeComplejaPM_0, 0), (self.uhd_usrp_sink_1, 0))
...
def main(top_block_cls=Prac5, options=None):
