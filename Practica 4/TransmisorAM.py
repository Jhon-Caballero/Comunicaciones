...
from medidaPotencia import medidaPotencia  # grc-generated hier_block
...
class TransmisorAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frec. Portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.medidaPotencia_0 = medidaPotencia(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.medidaPotencia_0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.medidaPotencia_0, 0))
