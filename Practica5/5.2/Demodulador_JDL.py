...
class Demodulador_JDL(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Demodulador_JDL")
    ...
    def set_Ga(self, Ga):
        self.Ga = Ga
        self.low_pass_filter_0.set_taps(firdes.low_pass(self.Ga, 200e3, 100e3, 10e3, window.WIN_HAMMING, 6.76))




def main(top_block_cls=Demodulador_JDL, options=None):
